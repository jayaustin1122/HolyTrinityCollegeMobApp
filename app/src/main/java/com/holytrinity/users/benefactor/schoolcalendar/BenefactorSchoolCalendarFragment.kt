package com.holytrinity.users.benefactor.schoolcalendar
...
class BenefactorSchoolCalendarFragment : Fragment() {

    private lateinit var binding: FragmentBenefactorSchoolCalendarBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBenefactorSchoolCalendarBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolbarBackButton.setOnClickListener {
            val bundle = Bundle().apply {
                putInt("selectedFragmentId", null ?: R.id.nav_Beneficiaries_benefactor)
            }
            findNavController().navigate(R.id.benefactorDrawerHolderFragment, bundle)
        }
    }
