package com.holytrinity.users.parent.schoolcalendar
...
import com.holytrinity.databinding.FragmentParentSchoolCalendarBinding
...
class ParentSchoolCalendarFragment : Fragment() {

    private lateinit var binding:FragmentParentSchoolCalendarBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentParentSchoolCalendarBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolbarBackButton.setOnClickListener {
            val bundle = Bundle().apply {
                putInt("selectedFragmentId", null ?: R.id.nav_child_parent)
            }
            findNavController().navigate(R.id.parentDrawerHolderFragment, bundle)
        }
    }
